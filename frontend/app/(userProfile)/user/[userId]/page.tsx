...
import { Calendar, Mail, MessageCircle, Star, UserPlus, Users } from "lucide-react";
              ...
              <div className="flex items-center gap-5 w-full">
                ...
                <div className="flex items-center justify-center sm:justify-between sm:pr-8 gap-4 flex-col sm:flex-row pb-4 w-full">
                  <div className="flex flex-col">
                    <div className="truncate text-2xl font-semibold text-white">{displayName}</div>
                    <div className="truncate text-sm text-[#8B949E]">{`@${user.firstName}`}</div>
