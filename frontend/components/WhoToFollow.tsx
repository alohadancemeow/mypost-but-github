        ...
        <section className="mt-10">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                {suggestions.map((user) => (
                    <div
                        key={user.handle}
                        className="flex items-center justify-between gap-4 rounded-md border border-[#30363D] bg-[#0D1117] px-4 py-3"
                    >
                        ...
                        <button
                            type="button"
                            className="h-8 shrink-0 rounded-md border border-[#30363D] bg-[#161B22] px-3 text-sm font-semibold text-[#58A6FF] hover:border-[#58A6FF]"
                        >
                            Follow
                        </button>
                    </div>
